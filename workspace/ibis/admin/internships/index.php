...
<br/><br/>
	...
	while($res = mysqli_fetch_array($result)) { 		
		echo "<tr>";
		echo "<td>".$res['internship_id']."</td>";
		echo "<td>".$res['description']."</td>";
		echo "<td>".$res['location']."</td>";
		echo "<td>".$res['company_id']."</td>";
		echo "<td><a href=\"edit.php?internship_id=$res[internship_id]\">Edit</a> | <a href=\"delete.php?internship_id=$res[internship_id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";		
	}
	?>
	</table>
	<p><a href="add_int.php" class="btn btn-primary">Add New Data</a></p>

      ...
      <div class="container wow fadeIn">
        ...
        <div class="row mia">
          ...
          <div class="centerView">
              ...
              <h4 class="title">Reports/Views</h4>
              <p class="description">
                 <a href="companies/view.php">Skills matched to placements</a><br>
                 <a href="companies/part.php">Internships Associated with particular Companies</a>
        </p>
